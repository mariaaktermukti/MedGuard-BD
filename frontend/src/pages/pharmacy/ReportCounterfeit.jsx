...
const PharmacyReportCounterfeit = () => (
    <CounterfeitReportPage
        title="Report Counterfeit Medicine"
        subtitle="Flag suspected counterfeit stock from a supplier or a customer so DGDA can investigate."
        locationLabel="Supplier / Location"
        locationPlaceholder="e.g. Supplier name, or where the stock came from"
    />
);

export default PharmacyReportCounterfeit;
